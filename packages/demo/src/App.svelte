...
<main>
  <a
    href="https://github.com/adammedford/svelte-carousel"
    class="github-corner"
    ...
    <svg
      ...
      height="80"
      viewBox="0 0 250 250"
      style="fill:#fff; color:#151513; position: absolute; top: 0; border: 0;
      z-index: 999; right: 0;"
      aria-hidden="true">
  ...
  <Carousel {slides} {delay} {displayCount} {autoplay} bind:this={car}>
    <div class="blue centered">
      <h1>Slide 1</h1>
    </div>
    <div class="red centered">
      <h1>Slide 2</h1>
    </div>
    <div class="yellow centered">
      <h1>Slide 3</h1>
    </div>
